...
async def bt(days):
 ...
 return {"candles":n,"strategies":out}
...
<div class=c><h1>AI BTC Scout - RESEARCH V6</h1><div class=m>BTC/USDT Â· 15m entries Â· 1h trend Â· 4 fixed strategies Â· PAPER ONLY</div><div id=s>Loading...</div></div>
...
<div class=c><h2>Research audit</h2><div class=m>Fixed hypotheses only - no tuning against the unseen 30%.</div>
<button onclick=run(180)>180 days</button><button onclick=run(365)>365 days</button><div id=b>Not run yet.</div></div>
</div><script>
